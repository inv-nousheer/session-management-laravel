                    ...
                    <tr>
                        <td style="padding: 34px 36px 12px;">
                            ...
                            <p style="margin: 0 0 24px; color: #475569; font-size: 15px; line-height: 1.7;">
                                {{ $uploaderName }} {{ $actionPhrase }} to the assessment "{{ $assessmentName }}".
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: separate; border-spacing: 0; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 18px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 18px 20px; border-bottom: 1px solid #e2e8f0;">
                                        <p style="margin: 0 0 6px; color: #64748b; font-size: 12px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;">Submitted By</p>
                                        <p style="margin: 0; color: #0f172a; font-size: 16px; font-weight: 700;">{{ $uploaderName }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 18px 20px;">
                                        <p style="margin: 0 0 6px; color: #64748b; font-size: 12px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;">Submission</p>
                                        <p style="margin: 0; color: #334155; font-size: 15px; line-height: 1.7;">{{ $submissionLabel }}</p>
                                    </td>
                                </tr>
                            </table>
